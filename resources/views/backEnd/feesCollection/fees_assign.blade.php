                        ...
                        <div class="white-box">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-right">
                                    ...
                                    <a href="#" class="primary-btn small fix-gr-bg" data-toggle="modal" data-target="#assignAllStudentsModal">
                                        <span class="ti-plus pr-2"></span>
                                        @lang('fees.assign_all_students')
                                    </a>
                                    <a href="#" class="primary-btn small fix-gr-bg" data-toggle="modal" data-target="#unassignAllStudentsModal">
                                        <span class="ti-minus pr-2"></span>
                                        @lang('fees.unassign_all_students')
                                    </a>
                                    @endif
                                </div>
                            </div>
                                    ...
                                    <x-table>
                                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" class="common-checkbox student_checkbox" name="student_ids[]" value="{{ $student->id }}" 
                                                            @if(in_array($student->id, $pre_assigned)) checked @endif>
                                                    </td>
                                                    <td>{{ $student->studentDetail->first_name.' '.$student->studentDetail->last_name }}</td>
                                                    <td>{{ $student->studentDetail->admission_no }}</td>
                                                    <td>{{ $student->class->class_name }}</td>
                                                    <td>{{ $student->studentDetail->parents->fathers_name }}</td>
