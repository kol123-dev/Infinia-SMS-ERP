...
class SmExaminationController extends Controller
{
    ...
    public function examAttendanceSearch(Request $request)
    {
        try {
            if (teacherAccess()) {
                // Check if teacher has access to the requested class/section
                if (!teacherHasAccessToClass($request->class, $request->section)) {
                    Toastr::error('You do not have access to this class/section', 'Failed');
                    return redirect()->back();
                }
            }
    ...
    public function examMarksRegister(Request $request)
    {
        try {
            if (teacherAccess()) {
                // Check if teacher has access to the requested class/section
            ...
            return view('backEnd.examination.masks_register', compact('exams', 'classes', 'subjects', 'exam_types'));
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
    ...
    public function examMarksRegisterSearch(Request $request)
    {
        try {
            if (teacherAccess()) {
                // Check if teacher has access to the requested class/section
