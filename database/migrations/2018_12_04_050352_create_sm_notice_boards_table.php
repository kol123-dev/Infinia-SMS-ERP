    ...
    public function up()
    {
        ...
        DB::table('sm_notice_boards')->insert([
            ...
            [
                ...
                'notice_message'    => "Stay tuned for exciting upcoming events at infinia  School, including Book Fair, Sports, and Debate competition. We encourage all students and parents to actively participate and make these events memorable experiences for the entire school community.",
                'notice_date'       => date("Y-m-d"),
                'publish_on'        => date("Y-m-d"),
                'inform_to'         => "[1]",
                'is_published'      => 1,
            ...
            [
                ...
                'notice_message'    => "infinia  School will be closed for the winter break from 15/12/2024 to 31/12/2024. We wish all our students and their families a joyful and restful holiday season.",
                'notice_date'       => date("Y-m-d"),
                'publish_on'        => date("Y-m-d"),
                'inform_to'         => "[1]",
                'is_published'      => 1,
